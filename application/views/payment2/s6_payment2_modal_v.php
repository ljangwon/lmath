      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <input type="text" name="add_year" value="<?= c_year() ?>" id="add_year" class="form-control" placeholder="Year">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-md-10">
              <input type="text" name="add_month" value="<?= c_month() ?>" id="add_month" class="form-control" placeholder="Month">
            </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group row">
            <label class="col-md-2 col-form-label">Year</label>
            <div class="col-md-10">
              <input type="text" name="year" value="<?= c_year() ?>" id="year" class="form-control" placeholder="Year">
            </div>
          </div>
          ...
          <div class="form-group row">
            <label class="col-md-2 col-form-label">Month</label>
            <div class="col-md-10">
              <input type="text" name="month" value="<?= c_month() ?>" id="month" class="form-control" placeholder="Month">
            </div>
          </div>
