        ...
        <html>
            <head>
                ...
                <meta name="viewport" content="width=device-width, initial-scale=1.0">
						...
						<link href="<?=$this->config->item('base_url')?>
								/static/lib/bootstrap/css/bootstrap.min.css" rel="stylesheet" media="screen">
						<style>
							body{
								padding-top:60px;
							}
						...
						<link href="<?=$this->config->item('base_url')?>
								/static/lib/bootstrap/css/bootstrap-responsive.css" rel="stylesheet">			    
            </head>
            ...
            <body>
            	...
            	<div class="navbar navbar-fixed-top">
				      ...
				      <a class="brand" href="#">학생리스트</a>
							<a class="brand" href="#">과제검사</a>
