...
<script type="text/javascript" src="/lmath/admin/vendor/jquery/jquery.min.js"></script>
<script type="text/javascript" src="/lmath/admin/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

<!-- Jquery-UI -->
<script type="text/javascript" src="https://code.jquery.com/ui/1.13.1/jquery-ui.js"></script>

<!-- Core plugin JavaScript-->
<script type="text/javascript" src="/lmath/admin/vendor/jquery-easing/jquery.easing.min.js"></script>

<!-- Custom scripts for all pages - admin Javascript-->
<script type="text/javascript" src="/lmath/admin/js/sb-admin-2.min.js"></script>

<!-- Page level plugins - Datatable Javascript-->
<script type="text/javascript" src="/lmath/admin/vendor/datatables/jquery.dataTables.min.js"></script>
<script type="text/javascript" src="/lmath/admin/vendor/datatables/dataTables.bootstrap4.min.js"></script>
