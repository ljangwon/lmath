            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="./icons.html">
                  ...
                  <span class="nav-link-title"> 1960 icons </span>
                </a>
              </li>
              <li class="nav-item dropdown">
        ...
        <div class="page-header d-print-none">
          <div class="row g-2 align-items-center">
            <div class="col">
              ...
              <h2 class="page-title">Dashboard - JakeLeanCo</h2>
            </div>
            <!-- Page title actions -->
        ...
        <div class="container-xl">
          <div class="row row-deck row-cards">
                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <p class="mb-3">
                        Using Storage
                        <strong>6854.45 MB </strong>of 8 GB
                      </p>
                      ...
                      <div class="divide-y">
                        ...
                        <div>
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="text-truncate">
                                <strong>Egan Poetz</strong>
                                registered new client as
                          ...
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="text-truncate">
                                ...
                                closed a new deal on project
                                <strong>Pen Pineapple Apple
                                  Pen</strong>.
                              </div>
                              <div class="text-muted">
                                2 days ago
                        ...
                        <div>
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="text-truncate">
                                <strong>Perren Keemar</strong>
                                and 3 others followed you.
                              </div>
                              <div class="text-muted">
                                2 days ago
                              </div>
                        ...
                        <div>
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="text-truncate">
                                <strong>Geoffry Flaunders</strong>
                                made a
                                <strong>$10</strong>
                                donation.
                              </div>
                        ...
                        <div>
                          <div class="row">
                            ...
                            <div class="col">
                              <div class="text-truncate">
                                <strong>Avivah Mugleston</strong>
                                mentioned you on
                  ...
                  <div class="row align-items-center">
                    <div class="col-10">
                      ...
                      <div class="markdown text-muted">
                        All icons come from the Tabler Icons set
                        and are MIT-licensed. Visit
                        <a href="https://tabler-icons.io" target="_blank" rel="noopener">tabler-icons.io</a>, download any of the 1960 icons in SVG,
                        PNG or&nbsp;React and use them in your
                  ...
                  <table class="table table-vcenter">
                    ...
                    <tr>
                      ...
                      <td class="text-end w-1">
                        <div class="
															chart-sparkline chart-sparkline-sm
            ...
            <div class="col-md-6 col-lg-4">
              <a href="https://github.com/sponsors/codecalm" class="card card-sponsor" target="_blank" rel="noopener" style="
										background-image: url(./static/sponsor-banner-homepage.svg);
                  ...
                  <table class="
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">UX Wireframes</a>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">New Dashboard</a>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">Landing Page</a>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">Marketing Templates</a>
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">Sales Presentation</a>
                        </td>
                        <td>
                          <span class="flag flag-country-br"></span>
                          Tabdaq
                      ...
                      <tr>
                        ...
                        <td>
                          <a href="invoice.html" class="text-reset" tabindex="-1">Logo & Print</a>
                        </td>
                        <td>
                          <span class="flag flag-country-us"></span>
                          Apple
