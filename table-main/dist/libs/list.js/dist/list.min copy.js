				...
				t.exports = function (t) {
					return (
						...
						function (e) {
							...
							return (
								t.update(), t.trigger("filterComplete"), t.visibleItems
							);
						}
					);
				};
				...
				t.exports = function (t) {
					var e = !1,
						r = function (r, s) {
							if (t.page < 1)
								return (
									(t.listContainer.style.display = "none"),
									void (e = !0)
								);
					...
					return function (e) {
						var n = new i(t.listContainer.id, {
							...
							searchClass:
								"pagination-search-that-is-not-supposed-to-exist",
					...
					var e = {
							...
							setOrder: function (r) {
								for (var n = 0, s = e.els.length; n < s; n++) {
									var i = e.els[n];
									if (
										t.utils.getAttribute(i, "data-sort") ===
										r.valueName
									) {
						...
						r = function () {
							...
							n
								...
								: (((r = arguments[1] || r).valueName = arguments[0]),
								  (r.order = r.order || "asc"),
								  (r.insensitive =
										void 0 === r.insensitive || r.insensitive)),
								e.clear(),
								e.setOrder(r);
							var s,
							...
							(s = i
								...
								: function (e, n) {
										...
										return (
											(s.alphabet =
												t.alphabet || r.alphabet || void 0),
											!s.alphabet &&
												r.insensitive &&
												(s = t.utils.naturalSort.caseInsensitive),
											s(
												e.values()[r.valueName],
												n.values()[r.valueName]
											) * a
										);
								  }),
								t.items.sort(s),
			...
			"./src/templater.js": function (t) {
				var e = function (t) {
					var e,
						...
						s = function () {
							for (
								var e = t.list.childNodes, r = 0, n = e.length;
								r < n;
								r++
							)
			...
			"./src/utils/get-by-class.js": function (t) {
				t.exports = function (t, e, r, n) {
					return ((n = n || {}).test && n.getElementsByClassName) ||
						...
						: (n.test && n.querySelector) ||
						  (!n.test && document.querySelector)
						? (function (t, e, r) {
								return (
									(e = "." + e),
					...
					Object.defineProperties(i, {
						alphabet: {
							...
							set: function (t) {
								...
								var s = 0;
								if ((e = t))
									for (; s < e.length; s++) r[e.charCodeAt(s)] = s;
